    ...
    <div className="grid gap-4">
      <RadioGroup defaultValue="admin" className="grid grid-cols-1 gap-4" value={role} onValueChange={(v) => setRole(v as Role)}>
        ...
        <div>
          ...
          <Label htmlFor="driver" className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary">
            Conductor
          </Label>
        </div>
        <div>
  ...
  return (
    <div className="w-full h-screen lg:grid lg:grid-cols-2">
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        <Image
          src="https://images.unsplash.com/photo-1525935944574-b83f00854666?q=80&w=1920&auto=format&fit=crop"
      ...
      <div className="flex items-center justify-center py-12">
        <div className="mx-auto grid w-[350px] gap-6">
          <div className="grid gap-2 text-center">
            ...
            <p className="text-balance text-muted-foreground">Accede a tu portal o regístrate para empezar</p>
          </div>
            ...
            <TabsContent value="login">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Elija su tipo de usuario para continuar.</CardDescription>
                </CardHeader>
            ...
            <TabsContent value="register">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Exclusivo para estudiantes y personal.</CardDescription>
                </CardHeader>
